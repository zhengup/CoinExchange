...
import org.zheng.bean.OrderRequestBean;
...
import org.zheng.service.HistoryService;
import org.zheng.service.SendEventService;
import org.zheng.service.TradingEngineApiProxyService;
            ...
            if (message.refId != null) {
                ...
                if (deferred != null) {
                    if (message.error != null) {
                        ...
                        ResponseEntity<String> resp = new ResponseEntity<>(JsonUtil.writeJsonAsString(message.result),
                                HttpStatus.OK);
                        deferred.setResult(resp);
                    }
                }
